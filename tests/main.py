...
CHUNK_SIZE = 100  # how many records to get from the database at a time
...
LEARNING_RATE = 1e-4
NUM_EPOCHS = 1
BATCH_SIZE = 1  # how many batches to cut each dataset chunk into
STOP_EARLY = CHUNK_SIZE * 5  # optional, to speed up local testing and stop before all the data has been fit, remove when done
...
if __name__ == '__main__':
    ...
    layers3 = [
        ...
        nn.ReLU(),
        # nn.Dropout(),
        nn.Linear(NUERONS_l2, 150),
        nn.ReLU(),
        nn.Linear(150, CHUNK_SIZE),
        nn.ReLU()
    ]
